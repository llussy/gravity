...
replace github.com/myesui/uuid => github.com/gorefa/uuid v1.0.1
...
require (
	...
	github.com/gorefa/uuid v1.0.0 // indirect
...
replace gopkg.in/stretchr/testify.v1 => github.com/stretchr/testify v1.7.0
